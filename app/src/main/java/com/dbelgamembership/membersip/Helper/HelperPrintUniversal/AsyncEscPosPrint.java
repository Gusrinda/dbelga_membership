...
public abstract class AsyncEscPosPrint extends AsyncTask<AsyncEscPosPrinter, Integer, Integer> {
    ...
    protected Integer doInBackground(AsyncEscPosPrinter... printersData) {
        ...
        try {
            ...
            this.publishProgress(com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_PRINTING);

            printer.printFormattedTextAndCut(printerData.getTextToPrint());

            this.publishProgress(com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_PRINTED);

        } catch (EscPosConnectionException e) {
            e.printStackTrace();
            return com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_PRINTER_DISCONNECTED;
        } catch (EscPosParserException e) {
            e.printStackTrace();
            return com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_PARSER_ERROR;
        } catch (EscPosEncodingException e) {
            e.printStackTrace();
            return com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_ENCODING_ERROR;
        } catch (EscPosBarcodeException e) {
            e.printStackTrace();
            return com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_BARCODE_ERROR;
        }

        return com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_SUCCESS;
    }
    ...
    protected void onProgressUpdate(Integer... progress) {
        switch (progress[0]) {
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_CONNECTING:
                this.dialog.setMessage("Connecting printer...");
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_CONNECTED:
                this.dialog.setMessage("Printer is connected...");
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_PRINTING:
                this.dialog.setMessage("Printer is printing...");
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.PROGRESS_PRINTED:
    ...
    protected void onPostExecute(Integer result) {
        ...
        switch (result) {
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_SUCCESS:
                new AlertDialog.Builder(context)
                        ...
                        .show();
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_NO_PRINTER:
                new AlertDialog.Builder(context)
                        .setTitle("No printer")
                        .setMessage("The application can't find any printer connected.")
                        .show();
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_PRINTER_DISCONNECTED:
                new AlertDialog.Builder(context)
                    .setTitle("Broken connection")
                    .setMessage("Unable to connect the printer.")
                    .show();
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_PARSER_ERROR:
                new AlertDialog.Builder(context)
                    .setTitle("Invalid formatted text")
                    .setMessage("It seems to be an invalid syntax problem.")
                    .show();
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_ENCODING_ERROR:
                new AlertDialog.Builder(context)
                    .setTitle("Bad selected encoding")
                    .setMessage("The selected encoding character returning an error.")
                    .show();
                break;
            case com.dbelgamembership.membersip.Helper.HelperPrintUniversal.AsyncEscPosPrint.FINISH_BARCODE_ERROR:
                new AlertDialog.Builder(context)
