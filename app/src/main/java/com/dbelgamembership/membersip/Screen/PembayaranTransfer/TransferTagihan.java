...
import com.dbelgamembership.membersip.Model.ResponseBayarTagihan.MsgServer;
...
public class TransferTagihan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("hasExtra")) {
            ...
            kodeTagihan = getIntent().getStringExtra("kode_tagihan");
            totalTagihan = getIntent().getStringExtra("dataTagihan");

//            intent.putExtra("dataTagigan", (Parcelable) dataTagihan);
        ...
        binding.btnAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TransferTagihan.this, SupportActivity.class);
    ...
    private void searchPaymentBNI(String trxId) {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(TransferTagihan.this, "Loading", "Getting VA ...");
        ...
        call.enqueue(new Callback<BniDetailPayment>() {
            ...
            public void onResponse(Call<BniDetailPayment> call, Response<BniDetailPayment> response) {
                try {
                    ...
                    if (response != null) {
                        Toast.makeText(TransferTagihan.this, "berhasil get data payment !", Toast.LENGTH_LONG).show();
                        ...
                        binding.btnCopyPembayaran.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Toast.makeText(TransferTagihan.this, "berhasil copy data : " + detailPayment.getData().getVirtualAccount(), Toast.LENGTH_SHORT).show();
                                ...
                                if (count >= 0) {
                                    ...
                                    binding.countdownTimer.setOnCountdownEndListener(new CountdownView.OnCountdownEndListener() {
                                        ...
                                        public void onEnd(CountdownView cv) {
                                            ...
                                            if (!detailPayment.getData().getVaStatus().equals("2")) {
                                                Toast.makeText(TransferTagihan.this, "Waktu untuk pembayaran berakhir !", Toast.LENGTH_SHORT).show();
                                    ...
                                    androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(TransferTagihan.this).create();
...
//                                                    methodCancelTransaksi();
                    ...
                    Toast.makeText(TransferTagihan.this, "Error Transfer", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void createNewVA() {
        ...
        try {
            ...
            PostBNI postBNI = new PostBNI(
                    ...
                    String.valueOf(Math.round((int) Double.parseDouble(totalTagihan))),
                    "c",
                    ...
                    templateVANumber,
                    formattedDate,
                    "TRANSAKSI PELUNASAN DEBIT : " + kodeTagihan
            );



            final ProgressDialog progressDialog = ProgressDialog.show(TransferTagihan.this, "Loading", "Pembuatan VA ...");
            APIInterface apiInterface = APIClient.getClient(Http.server).create(APIInterface.class);
            ...
            call.enqueue(new Callback<JsonElement>() {
                ...
                public void onResponse(Call<JsonElement> call, retrofit2.Response<JsonElement> response) {
                    try {
                        progressDialog.dismiss();
                        if (response != null) {
                            Toast.makeText(TransferTagihan.this, "Order berhasil, Lakukan Pelunasan Transfer !", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    } catch (Exception e) {
                        Log.e(TAG, "onResponse: " + e.getMessage());
...
//        /v1/briva/J104408/77777/9118
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            binding.btnCopyPembayaran.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    assert detailPayment != null;
                                    Toast.makeText(TransferTagihan.this, "berhasil copy data : " + detailPayment.getData().getCustCode(), Toast.LENGTH_SHORT).show();
    ...
    private void updateStatusTagihan() {
        final ProgressDialog progressDialog = ProgressDialog.show(TransferTagihan.this, "Loading", "Pengubahan status ...");
        APIInterface apiInterface = APIClient.getClient(Http.server).create(APIInterface.class);
        Call<String> callUpdate = apiInterface.doUpdateTagihanTransfer(kodeTagihan);

        callUpdate.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                progressDialog.dismiss();
                Toast.makeText(TransferTagihan.this, "Pembayaran berhasil, tunggu konfirmasi dari admin !", Toast.LENGTH_LONG).show();
