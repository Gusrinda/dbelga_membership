...
public class DummyAdapterPengambilanVoucherOmset extends RecyclerView.Adapter<DummyAdapterPengambilanVoucherOmset.myViewHolder> {
    ...
    public DummyAdapterPengambilanVoucherOmset(Context context, List<DummyModelVoucher> menuList, AdapterListVoucherDummyCallback adapterListDaftarSharedOmset) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder myViewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        myViewHolder.btnRedeemVoucher.setText("Pilih Voucher");
