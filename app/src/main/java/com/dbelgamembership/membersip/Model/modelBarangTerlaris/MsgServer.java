...
public class MsgServer implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = -145729928673696458L;

    protected MsgServer(android.os.Parcel in) {
        this.currentPage = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.data, (com.dbelgamembership.membersip.Model.ModelBarangTerlaris.Datum.class.getClassLoader()));
