...
public class MsgServer implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 6360703903617729553L;
    ...
    protected MsgServer(Parcel in) {
        ...
        this.kategoriProduk = ((String) in.readValue((String.class.getClassLoader())));
    ...
    public MsgServer withKategoriProduk(String kategoriProduk) {
        this.kategoriProduk = kategoriProduk;
        return this;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(kategoriProduk);
